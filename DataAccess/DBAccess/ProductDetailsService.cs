...
namespace DataAccess.DBAccess
{
    public class ProductDetailsService : IProductDetailsService
    {
        ...
        public async Task<IEnumerable<ProductDetails>> GetAllProductsInWareHouse(int warehouseId)
        {
            _dbContext.SetConnectionString("DefaultConnection");
            var storedProcedureName = "GetAllProductsInWareHouse";
        ...
        public async Task<IEnumerable<ProductDetails>> GetProductDetailByIdAndExpiryDateAsync(int detailId)
        {
            _dbContext.SetConnectionString("DefaultConnection");
